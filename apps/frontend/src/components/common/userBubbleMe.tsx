...
export const UserBubbleMe = ({ src, type = "normal" }: UserBubbleMeProps) => {
  if (type === "ai") {
    return (
      <div className="bg-[#5197FF] w-fit max-w-[100%] mt-[20px]  p-4 rounded-[20px] flex flex-col gap-2 float-right text-sm">
